...
priors= ["Gaussian(1,0.5):syst"]

stack.add_plot(["Deltam2_32", "Theta23"],priors,[50,50],[[2.2E-3,2.7E-3],[0.7,0.9]])
stack.add_plot(["DeltaCP"],priors,[-np.pi, -0.95*np.pi, -0.9*np.pi, -0.85*np.pi, -0.8*np.pi, -0.75*np.pi,
...
stack.add_plot(["syst", "Theta23"],priors,[50,50],[[-2,4],[0.7,0.9]])
